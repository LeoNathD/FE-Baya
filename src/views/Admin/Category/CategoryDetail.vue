                    ...
                    <div class="row flex items-center gap-5">
                        <div class="flex items-center gap-[10px] w-full">
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                <p class="font-semibold text-custom-grey leading-none">{{ childern?.product_count }} Products</p>
                            </div>
                        </div>
                        <div class="flex items-center gap-[14px]">
                            <button
                                class="flex items-center justify-center size-14 shrink-0 rounded-2xl p-4 gap-2 bg-custom-red/10" @click="handeDelete(childern.id)">
                                <img src="@/assets/images/icons/trash-red.svg" class="flex size-6 shrink-0" alt="icon">
                            </button>
                            <RouterLink :to="{ name: 'admin.category.edit', params: { id: childern.id }, query: { parent_id: productCategory.id } }"
