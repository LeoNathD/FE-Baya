                ...
                <div class="flex gap-[72px]">
                    <div class="flex flex-col gap-6 w-[349px]">
                        <a href="main.html" class="flex shrink-0">
                            <img src="@/assets/images/logos/baya.png" class="h-12" alt="logo">
                        </a>
                        <p class="font-medium text-custom-grey">Baya adalah sebuah toko yang bertujuan mempermudah keluarga untuk membeli keperluan bulanan tanpa keluar rumah</p>
                    </div>
