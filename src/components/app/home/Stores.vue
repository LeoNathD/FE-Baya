        ...
        new Swiper('.storeSwiper', {
            ...
            pagination: {
                ...
                renderBullet: function (index, className) {
                    return '<span class="flex shrink-0 !w-[42px] !h-1 rounded-full has-[&.swiper-pagination-bullet-active]:!bg-custom-black ' + className + '"></span>';
                },
            },
            navigation: {
...
<template>
    <section id="Trusted-Seller" class="flex flex-col gap-9">
            ...
            <div class="flex flex-col gap-6 relative">
                ...
                <div class="flex flex-col gap-6 relative">
                    <div class="relative flex items-center justify-center gap-6 h-14 w-fit mx-auto mt-4">
                        <button
                            class="custom-prev flex shrink-0 items-center justify-center size-14 rounded-full border border-custom-stroke hover:bg-gray-100 transition-colors cursor-pointer disabled:opacity-50">
                            <img src="@/assets/images/icons/arrow-right-black.svg" class="size-6 rotate-180" alt="icon">
                        </button>

                        <div class="swiper-pagination !relative !flex !items-center !gap-2 !w-auto !top-0 !bottom-0">
                        </div>

                        <button
                            class="custom-next flex shrink-0 items-center justify-center size-14 rounded-full border border-custom-stroke hover:bg-gray-100 transition-colors cursor-pointer disabled:opacity-50">
